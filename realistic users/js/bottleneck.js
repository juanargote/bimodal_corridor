...
Bottleneck.prototype = {
    ...
    sortArrivalIndex: function(){
        ...
        // Generate random arrival times based on users' target arrival times
        this.userArray.map(function(d){return d.setRandomArrivalTime()});

        // Sort users by actual arrival time
